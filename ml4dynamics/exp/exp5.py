...
def main():
  ...
  for i in range(len(model_type)):
    print(
      "{} & {:.2e} & {:.2e} & {:.2e} & {:.2e} & {:.2e} \\\\\n".format(
        model_type[i], rt[i, 0], rt[i, 1], rt[i, 2], rt[i, 3], rt[i, 4]
      )
    )
  print(
    "Diff & {:.1f}\% & {:.1f}\% & {:.1f}\% & {:.1f}\% & {:.1f}\% \\\\\n".format(
      100 - rt[3, 0] * 100 / rt[0, 0], 100 - rt[3, 1] * 100 / rt[0, 1],
      100 - rt[3, 2] * 100 / rt[0, 2], 100 - rt[3, 3] * 100 / rt[0, 3],
      100 - rt[3, 4] * 100 / rt[0, 4]
    )
  )
  print("\\hline\n")
