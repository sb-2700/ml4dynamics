...
arg, u, v, label = read_data('../data/{}/{}-{}.npz'.format(simutype, n, ds_parameter))

nx, ny, dt, T, label_dim, traj_num, step_num, u, v, label = preprocessing(arg, simutype, u, v, label, device)
