...
arg, U, label = read_data(
  '../data/{}/{}-{}.npz'.format(simutype, n, ds_parameter)
)

nx, ny, dt, T, label_dim, traj_num, step_num, U, label = preprocessing(
  arg, simutype, U, label, device
)

print(
  'Training {} model with n = {}, beta = {:.1f}, Re = {} ...'.format(
    simutype, n, beta, Re
  )
)
...
if os.path.isfile(
  '../models/{}/OLS-{}-{}.pth'.format(simutype, n, ds_parameter)
):
  ...
  model_ols.eval()
if os.path.isfile(
  '../models/{}/mOLS-{}-{}.pth'.format(simutype, n, ds_parameter)
):
  ...
  model_mols.eval()
if os.path.isfile(
  '../models/{}/aOLS-{}-{}.pth'.format(simutype, n, ds_parameter)
):
  ...
  model_aols.eval()
if os.path.isfile(
  '../models/{}/TR-{}-{}.pth'.format(simutype, n, ds_parameter)
):
...
if os.path.isfile(
  '../models/{}/ED-{}-{}.pth'.format(simutype, n, ds_parameter)
):
